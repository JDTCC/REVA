...
/**
 * MessageBodyWirter for <code>ResultSet</code>. Resulting output is Microsoft Excel 2007 
 * (.xls)
 * 
 */
@Component
...
@Provider
public class ResultSetXlsMessageBodyWriter implements MessageBodyWriter<ResultSet> {

  public ResultSetXlsMessageBodyWriter() {}
  ...
  /**
   * Write a single workbook line using the given line data.
   * 
   * @param row spreadsheet row to write to.
