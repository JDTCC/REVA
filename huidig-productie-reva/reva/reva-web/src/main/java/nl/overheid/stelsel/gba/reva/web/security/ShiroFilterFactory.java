...
/**
 * Speciale web filter om shiro gebaseerde beveiliging mogelijk te maken. Dit
 * filter zorgt voor de juiste initialisatie van Apache Shiro.
 * 
 */
public class ShiroFilterFactory implements FilterFactory {
   ...
   * additionally perform configuration and initialization behavior.
   */
