 ...
 * registraties dat door loketgemeenten zijn aangemaakt.
 * 
 */
@PaxWicketMountPoint( mountPoint = "/rapportage/doorLoketGemeente" )
@ShiroSecurityConstraint( constraint = ShiroConstraint.HasPermission, value = "query:rapportageDoorLoketGemeente" )
public class DoorGemeenteRapportagePage extends RevaPage {
  ...
  private static final String FIELD_INSCHRIJVENDE_GEMEENTE = "gemeenteVanInschrijvingCode";
  ...
  static {
    COLUMN_NAMES.add( FIELD_INSCHRIJVENDE_GEMEENTE );
  ...
  public DoorGemeenteRapportagePage( PageParameters parameters ) throws Exception {
    ...
    resultatenPanel.setResultQueryName( "rapportageDoorLoketGemeente" );
    resultatenPanel.setCountQueryName( "rapportageDoorLoketGemeenteCount" );
    add( resultatenPanel );

    PageParameters queryParameters = new PageParameters( filtered );
    queryParameters.add( QueryAsXlsResource.QUERY_NAME_PARAM, "rapportageDoorLoketGemeente" );
    ...
    Form<RapportageCriteria> form = new Form<RapportageCriteria>( "rapportageFormulier" ) {
      ...
      public void onSubmit() {
        ...
        setResponsePage( DoorGemeenteRapportagePage.class, parameters );
        super.onSubmit();
      }
    };
